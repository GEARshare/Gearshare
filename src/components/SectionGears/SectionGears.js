...
import css from './SectionGears.module.css';

import helsinkiImage from '../SectionLocations/images/location_helsinki.jpg';
import rovaniemiImage from '../SectionLocations/images/location_rovaniemi.jpg';
import rukaImage from '../SectionLocations/images/location_ruka.jpg';
...
SectionGears.defaultProps = { rootClassName: null, className: null };

const { string } = PropTypes;

SectionGears.propTypes = {
  rootClassName: string,
  className: string,
};

export default SectionGears;